(async function () {
    ...
    widgetContainer.style.position = "fixed"; // Use 'fixed' for the position
  ...
  document.head.appendChild(tailwindScript);
    ...
    widgetContainer.innerHTML = `
      <div class="pt-28" style={{
              ...
              >
                  <div class="w-[380px] rounded-xl font-light bg-[#2c2c2c] text-white text-sm  p-4 mx-auto"
                      style={{
                          borderRadius: "18px",
                  ...
                  >
                      <div class="w-full justify-between flex items-center">
                          ...
                          <div class="rounded-full bg-[#3D3D3D] px-2 cursor-pointer py-1 flex items-center justify-center gap-1">
                              <p class="">Auto save</p>
                      ...
                      <div class="mt-4 flex items-center w-full">
                          <div class="flex items-center w-full">
                              <p class="px-3.5 cursor-pointer">Design</p>
                              <p class="px-3.5 cursor-pointer">Advanced</p>
                              <p class="px-3.5 cursor-pointer">Presets</p>
                          </div>
                      </div>
                      <div class="bg-[#494949] w-full h-[2px] mt-3 relative">
                          <div class="absolute bg-[#EF7C2F] h-[2px] top-0 left-0 w-16"></div>
                      </div>
      
                      <div class="mt-4 pb-3 rounded-[15px] bg-[#3D3D3D] ">
                          ...
                          <div class="bg-[#494949] mt-4 w-full h-[1px]"></div>
                          <div class="px-3 mt-2">
                              <div class="w-full flex items-center justify-between">
                                  <div class="flex items-center gap-2">
      
                                      <div class="flex  items-center justify-end bg-[#EF7C2F]  rounded-[22px] h-[15px] w-[26px] p-[1px] gap-[10px] relative">
                                          <div class="bg-[#F2F2F2] rounded-[6px] h-[13px] absolute top-[1px] w-[13px]"></div>
                                      </div>
                                      <p>Enable</p>
                                  </div>
      
                                  <div class="flex items-center gap-2 rounded-full px-2.5 cursor-pointer py-[1px] bg-[#494949]">
                                      <p class="">Reset</p>
                              ...
                              <div class="flex mt-4 items-center w-full justify-between gap-2.5">
                                  <button class="bg-[#EF7C2F] w-full text-center rounded-md py-1.5 hover:bg-[#d87838] transition-all duration-300">Normal</button>
                                  <button class="bg-[#494949] w-full text-center rounded-md py-1.5 hover:bg-[#494848] transition-all duration-300">Hover</button>
                              </div>
                              ...
                              <div class="mt-2 grid grid-cols-12 w-full justify-between gap-3">
                                  <div class="col-span-8 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      <p class="py-1 px-3"> SF Pro Sans</p>
                                      <div class="bg-[#525151] px-2 h-full">
                                  ...
                                  <div class="col-span-4 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      <p class="text-center mx-auto"> 14</p>
                              ...
                              <div class="mt-3 grid grid-cols-12 w-full justify-between gap-3">
                                  <div class="col-span-7 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                  ...
                                  <div class="col-span-4 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      ...
                                      </div>                                <div class="h-full w-[1px] bg-gray-500"></div>
                              ...
                              <div class="mt-3 grid grid-cols-12 h-8 w-full justify-between gap-3">
                                  ...
                                  <div class="col-span-5 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      <div class="w-full">
                                  ...
                                  <div class="col-span-3 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      <div class="w-full">
                                  ...
                                  <div class="col-span-3 justify-between flex items-center bg-[#3f3f3f] border-[#585858] border w-full  rounded">
                                      <div class="w-full">
                                          <p class="text-center text-xs">Auto</p>                                </div>                                <div class="h-full w-[1px] bg-gray-500"></div>
